  ...
  render() {
    return (
      <Container>
        <Image />
        <Content >
          <Typography className={this.props.classes.name} style={{ top: '340px', opacity: (1 - (this.state.scrollY / 400)) }}>
            Hello, I'm Rohit Sharma.
          </Typography>
          <Typography className={this.props.classes.name} style={{ top: '400px', opacity: (1 - (this.state.scrollY / 400)) }}>
            I can help you in creating awesome apps.
          </Typography>
          <Button className={this.props.classes.btn}>why don't you say hi?</Button>
        </Content>
      </Container>
    );
  }
